# -----------------------------------------------
# 🔸 ISTKHAR MUSIC Project — ChatFight Mini-Games
# 🔹 Word / Emoji / Flag guessing games with MongoDB leaderboard
# 🔹 Adapted from SUDEEPBOTS chatfight.py for ISTKHAR_MUSIC
# -----------------------------------------------
import time
import asyncio
import os
...
TEMPLATE_PATH = "ISTKHAR_MUSIC/assets/template.jpg"
FONT_PATH = "ISTKHAR_MUSIC/assets/font.ttf"
