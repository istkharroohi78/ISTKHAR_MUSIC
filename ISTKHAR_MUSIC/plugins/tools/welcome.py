...
# 🔹 Developed & Maintained by: ISTKHAR (https://github.com/TEAM-ISTKHAR)
...
from ISTKHAR_MUSIC.utils.database import add_served_chat, get_assistant, is_active_chat
from ISTKHAR_MUSIC.misc import SUDOERS
from ISTKHAR_MUSIC.mongo.afkdb import PROCESS
...
async def greet_new_member(_, member: ChatMemberUpdated):
    ...
    if member.new_chat_member and not member.old_chat_member and member.new_chat_member.status != "kicked":
        ...
        try:
            ...
            pic = "ISTKHAR_MUSIC/assets/upic.png"
